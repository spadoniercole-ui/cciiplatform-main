...
import { ParametriVisualizzazioneViewer } from '@/components/spazio/ParametriVisualizzazioneViewer';

export default async function ParametriVisualizzazionePage({
  params,
}: {
  ...
  return (
    <div className="max-w-4xl space-y-4">
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-6">
        <ParametriVisualizzazioneViewer nomeSchema={contesto.nomeSchema} />
      </div>
    </div>
  );
}
