...
import { ParametriStampaManager } from '@/components/spazio/ParametriStampaManager';

export default async function ParametriStampaPage({
  params,
}: {
  ...
  return (
    <div className="max-w-5xl space-y-4">
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-6">
        <ParametriStampaManager nomeSchema={contesto.nomeSchema} codice={codice} />
      </div>
    </div>
  );
}
