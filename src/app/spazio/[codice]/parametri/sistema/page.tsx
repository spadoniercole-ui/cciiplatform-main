...
import { ParametriSistemaViewer } from '@/components/spazio/ParametriSistemaViewer';

export default async function ParametriSistemaPage({
  params,
}: {
  ...
  return (
    <div className="max-w-4xl space-y-4">
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-6">
        <ParametriSistemaViewer nomeSchema={contesto.nomeSchema} />
      </div>
    </div>
  );
}
