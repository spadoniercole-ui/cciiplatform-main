...
import { AnagraficaEnteConfigManager } from '@/components/spazio/AnagraficaEnteConfigManager';

export default async function ParametriAnagraficaEntePage({
  params,
}: {
  ...
  return (
    <div className="max-w-4xl space-y-4">
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-6">
        <AnagraficaEnteConfigManager nomeSchema={contesto.nomeSchema} />
      </div>
    </div>
  );
}
